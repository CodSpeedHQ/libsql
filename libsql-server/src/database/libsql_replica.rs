...
pub type LibsqlReplicaConnection = TrackedConnection<
    WriteProxyConnection<Streaming<ExecResp>, LibsqlConnection>,
>;
type LibsqlReplicaConnectionMaker = MakeThrottledConnection<MakeWriteProxyConn<MakeLibsqlConnection>>;
